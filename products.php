...
<button class="btn btn-outline-primary mt-2 view-3d" data-id="<?php echo $product['id']; ?>" data-model="models/product_<?php echo $product['id']; ?>.gltf">3D View</button>                                    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="view3DModalLabel">3D Product View</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <canvas id="view3DCanvas" style="width: 100%; height: 400px;"></canvas>
                <div id="view3DInstructions" class="position-absolute bottom-0 start-0 m-2 text-muted">Rotate: Click & Drag | Zoom: Scroll</div>
            </div>
        </div>
    </div>
</div>
...
<script src="https://unpkg.com/three@0.128.0/examples/js/loaders/GLTFLoader.js"></script>
    ...
    button.addEventListener('click', function() {
        ...
        document.getElementById('view3DModal').addEventListener('hidden.bs.modal', () => {
            renderer.dispose();
